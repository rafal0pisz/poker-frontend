  ...
  return (
    <div className="container">
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        <span style={{ color: 'rgba(var(--pk-cream-rgb),0.2)', margin: '0 0.5rem' }}>›</span>
        <span style={{ fontSize: '0.85rem', color: 'rgba(var(--pk-cream-rgb),0.6)' }}>Poker Heads-Up</span>
      </div>
      <div style={{ maxWidth: 720, marginTop: '1.5rem' }}>
        ...
        <p style={{ color: 'rgba(var(--pk-cream-rgb),0.4)', fontSize: '0.85rem', marginBottom: '2rem' }}>2 czerwca 2026 · 7 min czytania</p>
        <div className="prose">
          <p>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "Article",
              "headline": "Poker Heads-Up — zasady i strategia gry 1 na 1",
              ...
              "mainEntityOfPage": "https://pokero.pl/blog/poker-heads-up/"
            }),
          }}
        />
      </div>

      ...
      <main style={{ padding: '3rem 0 4rem' }}>
        <div className="container" style={{ maxWidth: 560 }}>
          <div style={{ marginBottom: '0.5rem' }}>
            ...
            <span style={{ fontSize: '0.85rem', color: 'rgba(245,230,192,0.6)' }}>Kontakt</span>
          </div>
          ...
          <div className="card" style={{ marginBottom: '1rem' }}>
            <p style={{ fontSize: '0.75rem', color: 'rgba(245,230,192,0.4)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>Wersja aplikacji</p>
            <p style={{ fontFamily: 'monospace', color: '#d4af37', marginBottom: 0 }}>v1.0.0</p>
          </div>

          <div className="card">
            <p style={{ fontSize: '0.75rem', color: 'rgba(245,230,192,0.4)', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '0.5rem' }}>O Pokero</p>
            <p style={{ fontSize: '0.9rem', color: 'rgba(245,230,192,0.6)', margin: 0, lineHeight: 1.6 }}>

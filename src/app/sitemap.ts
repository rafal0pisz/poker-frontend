...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/poker-online-z-przyjaciolmi/`, lastModified: now, changeFrequency: 'monthly', priority: 0.95 },
    { url: `${base}/kalkulatory/porownanie-wariantow/`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },
    { url: `${base}/zasady/omaha-pot-limit/`, lastModified: now, changeFrequency: 'monthly', priority: 0.8 },

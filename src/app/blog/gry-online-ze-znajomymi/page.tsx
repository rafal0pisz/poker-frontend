  ...
  return (
    <div className="container">
      <div style={{ marginBottom: '0.5rem' }}>
        ...
        <span style={{ color: 'rgba(var(--pk-cream-rgb),0.2)', margin: '0 0.5rem' }}>›</span>
        <span style={{ fontSize: '0.85rem', color: 'rgba(var(--pk-cream-rgb),0.6)' }}>Gry online ze znajomymi</span>
      </div>
      <div style={{ maxWidth: 720, marginTop: '1.5rem' }}>
        ...
        <p style={{ color: 'rgba(var(--pk-cream-rgb),0.4)', fontSize: '0.85rem', marginBottom: '2rem' }}>30 maja 2026 · 7 min czytania</p>
        <div className="prose">

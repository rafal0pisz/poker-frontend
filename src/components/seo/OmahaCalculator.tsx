  ...
  return (
    <div style={{background:'#1a1a2a',border:'1px solid rgba(212,175,55,0.2)',borderRadius:16,padding:'clamp(1rem,4vw,1.5rem)',maxWidth:700}}>
      ...
      <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'1rem',marginBottom:'1.25rem'}}>
        <div>
          <div style={{fontSize:'0.7rem',fontWeight:600,color:'rgba(212,175,55,0.6)',letterSpacing:'0.07em',textTransform:'uppercase',marginBottom:8}}>
        ...
        <div>
          ...
          <div style={{marginTop:8,padding:'6px 10px',background:'rgba(212,175,55,0.06)',borderRadius:8,fontSize:11,color:'rgba(245,230,192,0.5)',lineHeight:1.4}}>
